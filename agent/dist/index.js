    ...
    var a = layui.setter,
        ...
        r = function(e) {
            ...
            if(layui.each(a.indPage, function(e, a) {
                ...
                if(a.interceptor) {
                    var u = layui.sessionData(a.tableName);
                    if(!u[a.request.tokenName]) return location.hash = "/user/login";
        ...
        s = layui.$,
        c = s(window);
    layui.link(a.base + "style/admin.css?v=" + (new Date().getTime()), function() {
        r()
