...
;layui.define(["laytpl", "layer"], function(e) {
    ...
    i.loading = function(e) {
        ...
        layui.sessionData(r.tableName, null),
        ...
        return e.data = JSON.stringify(e.data) || {},
            //e.headers = e.headers || {},
            //e.url.indexOf('login') == -1 && n.tokenName && (e.headers[n.tokenName] = n.tokenName in e.headers ? e.headers[n.tokenName] : layui.sessionData(r.tableName)[n.tokenName] || ""),
            e.url = e.url.indexOf('localhost\/') != -1 ? e.url.replace(/localhost\//, '') : n.apiUrl + e.url,
            e.type = e.type || "post",
            ...
            t.ajax(t.extend({
                ...
                beforeSend: function(req) {
                    req.setRequestHeader("token", layui.sessionData(r.tableName)[n.tokenName] || "");
                }, success: function(t) {
                    var n = o.statusCode;
            ...
            var s = this,
                ...
                y = layui.router();
            l.find("title").remove(),
            s.container[n ? "after" : "html"](l.children()), y.params = s.params || {};
